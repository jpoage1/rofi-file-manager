# Path: old/menu_manager/interface.py
...
from core.payload import send_message, recv_message
from menu_manager.frontend import run_fzf, run_rofi, run_cli_selector
from core.payload import get_timestamp

def run_socket_client(host, port, frontend, timeout=2.0, interval=0.05):
    start = time.time()
    connection = False
